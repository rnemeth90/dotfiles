...
Set-AzKeyVaultAccessPolicy -VaultName $keyVaultName -ResourceGroupName $resourceGroupName -ObjectId $objID -PermissionsToKeys create,delete,list,get,verify,encrypt,wrapkey
